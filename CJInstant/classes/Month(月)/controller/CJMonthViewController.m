...
@interface CJMonthViewController ()<addViewControllerDelegate>
/** 时间处理 */
...
-(void)loadData{
    ...
    NSInteger lastWeekToDay = today + (60 * 60 * 24) * 30;
    // 1465084800 1465689600
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"datetime >= %f AND datetime <= %ld", today, lastWeekToDay];
